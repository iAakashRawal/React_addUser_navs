...
const UseRefs = () => {
    ...
    console.log("object", collectData)
    return (
        <Container fluid>
            <header>
                ...
                <div className="tab-content" id="myTabContent">
                    <div className="tab-pane  pt-5" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div className=" d-flex justify-content-center">
                            <div className="shadow p-3 mb-5 bg-light rounded w-50  ">
                    ...
                    <div className="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div className="p-3 h-100 bg-info  mt-3">
                            <p className='ps-3 bg-light text-info m-2 rounded fs-4'> ☻User imformation</p>
                            <Row className='mt-2 shadow m-3 p-5 mb-5 bg-light rounded'>
                                <Col
                                    className="mb-2 text-muted pt-2 col-7 mt-5">
                                    <p className='fs-5'><b>Student name</b> :{nameD}</p>
                                    <p className='fs-5'><b>Role </b> : {role}</p>
                                    <p className='fs-5'><b>Description</b> : {description}</p>
                                </Col>
                                <Col className='col-5'>
                                    <img alt='s' src={imgs} className="w-100 h-100"></img>
                                </Col>
                            </Row>
                        </div>
                    </div>
